                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-condensed">
                    <tbody>
                      ...
                      <tr>
                        <td class='col-md-3'>Nit:</td>
                        <td><input type="text" class="form-control input-sm" name="nit" value="<?php echo $row['nit']?>" required></td>
                      </tr>
                      <tr>
                        <td>Teléfono:</td>
					  ...
					  <tr>
                        <td>IVA (%):</td>
                        <td><input type="number" class="form-control input-sm" required name="impuesto" value="<?php echo $row['impuesto']?>"></td>
                      </tr>
                      <tr>
                      	<td>Resolucion Dian:</td>
                      	<td><input type="text" class="form-control input-sm" required name="resolucion_dian" value="<?php echo $row['resolucion_dian']?>"></td>
                      </tr>
					  <tr>
