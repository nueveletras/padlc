    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
			...
			<td style="width: 50%; color: #34495e;font-size:12px;text-align:center">
                <span style="color: #34495e;font-size:14px;font-weight:bold"><?php echo get_row('perfil','nombre_empresa', 'id_perfil', 1);?></span><br>
                <span style="color: #34495e;font-size:14px;font-weight:bold">NIT:<?php echo get_row('perfil','nit', 'id_perfil', 1);?></span>
				...
				Resolucion Dian: <?php echo get_row('perfil', 'resolucion_dian', 'id_perfil', 1); ?>
