		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  ...
			  <div class="form-group">
				<label for="mod_stock" class="col-sm-3 control-label">iva</label>
				<div class="col-sm-8">
				  <input type="number" class="form-control" id="mod_iva" name="mod_iva" placeholder="Nuevo valor del iva" required >
				</div>
			  </div>
			 ...
			 <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="number" class="form-control" id="mod_stock" name="mod_stock" placeholder="Nueva cantidad en el stock del producto" required >
				</div>
			  </div>
