		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax_productos"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="number" class="form-control" id="iva" name="iva" placeholder="porcetaje del impuesto" required>
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="number" class="form-control" id="stock" name="stock" placeholder="Existencia del producto" required>
				</div>
			  </div>
