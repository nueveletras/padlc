<?php
	...
	if (empty($_POST['nombre_empresa'])) {
           ...
           $errors[] = "Dirección esta vacío";
        } else if (empty($_POST['resolucion_dian'])) {
           $errors[] = "Resoluciuon Dian esta vacio";   
        }   else if (
		...
		$res_dian=mysqli_real_escape_string($con,(strip_tags($_POST["resolucion_dian"],ENT_QUOTES)));
		
		$sql="UPDATE perfil SET nombre_empresa='".$nombre_empresa."', nit='".$nit."', telefono='".$telefono."', email='".$email."', impuesto='".$impuesto."', resolucion_dian='".$res_dian."', moneda='".$moneda."', direccion='".$direccion."', ciudad='".$ciudad."', estado='".$estado."', codigo_postal='$codigo_postal' WHERE id_perfil='1'";
