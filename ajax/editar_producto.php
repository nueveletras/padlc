<?php
	...
	if (empty($_POST['mod_id'])) {
           ...
           $errors[] = "Código vacío";
			...
			$errors[] = "Impuesto vacio";	
		} else if (empty($_POST['mod_stock'])){
			$errors[] = "Cantidad del stock vacio";	
		} else if (
			!empty($_POST['mod_id']) &&
		...
		$iva=intval($_POST['mod_iva']);
		$stock=intval($_POST['mod_stock']);
		$id_producto=$_POST['mod_id'];
		$sql="UPDATE products SET codigo_producto='".$codigo."', nombre_producto='".$nombre."', status_producto='".$estado."', precio_producto='".$precio_venta."', stock='".$stock."', iva='".$iva."' WHERE id_producto='".$id_producto."'";
