<?php
	...
	if (isset($_GET['id'])){
		...
		$del3="update products p SET p.stock=p.stock + (select sum(cantidad) from detalle_factura d where d.id_producto=p.codigo_producto and d.numero_factura='".$numero_factura."' group by d.id_producto) where id_producto in (select id_producto from detalle_factura where numero_factura='".$numero_factura."')";
		$del1="delete from facturas where numero_factura='".$numero_factura."'";
		$del2="delete from detalle_factura where numero_factura='".$numero_factura."'";
		if ($delete3=mysqli_query($con,$del3) and $delete1=mysqli_query($con,$del1) and $delete2=mysqli_query($con,$del2)){
			?>
