...
$id_product=get_row('detalle_factura', 'id_producto', 'id_detalle', $id_detalle);
$stock=get_row('products', 'stock', 'id_producto', $id_product);
$cant=get_row('detalle_factura', 'cantidad', 'id_detalle', $id_detalle);
$stock_u=$stock+$cant;
$up_stock=mysqli_query($con, "UPDATE products SET stock='".$stock_u."' WHERE id_producto='".$id_product."'");
...
<?php
	...
	$sumador_iva+=$iva_p_r;
		...
		<tr>
			...
			<td class='text-right'><?php echo $iva_producto;?>%</td>
...
<tr>
	<td class='text-right' colspan=5>IVA<?php echo $simbolo_moneda;?></td>
